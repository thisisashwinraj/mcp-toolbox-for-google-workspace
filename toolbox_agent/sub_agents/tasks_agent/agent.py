...
from .prompts import TASKS_AGENT_SYSTEM_INSTRUCTIONS
...
MODEL_TASKS_AGENT: str = "gemini-2.5-flash"

CURRENT_DIR = os.getcwd()
SERVER_PATH = os.path.join(
    CURRENT_DIR, "src", "mcp_server", "google_tasks", "server.py"
)
...
google_tasks_mcp_toolset = MCPToolset(
...
tasks_agent = LlmAgent(
    model=MODEL_TASKS_AGENT,
    name='tasks_agent',
    description='An agent to assist with Google Tasks related tasks.',
    instruction=TASKS_AGENT_SYSTEM_INSTRUCTIONS,
