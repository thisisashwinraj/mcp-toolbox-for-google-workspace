...
from .prompts import GMAIL_AGENT_SYSTEM_INSTRUCTIONS
...
MODEL_GMAIL_AGENT: str = "gemini-2.5-flash"

CURRENT_DIR = os.getcwd()
SERVER_PATH = os.path.join(
    CURRENT_DIR, "src", "mcp_server", "gmail", "server.py"
)
...
gmail_agent = LlmAgent(
    model=MODEL_GMAIL_AGENT,
    name='gmail_agent',
    description='An agent to assist with Gmail related tasks.',
    instruction=GMAIL_AGENT_SYSTEM_INSTRUCTIONS,
