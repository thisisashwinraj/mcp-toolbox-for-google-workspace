...
from .prompts import CALENDAR_AGENT_SYSTEM_INSTRUCTIONS
...
MODEL_CALENDAR_AGENT: str = "gemini-2.5-flash"

CURRENT_DIR = os.getcwd()
SERVER_PATH = os.path.join(
    CURRENT_DIR, "src", "mcp_server", "google_calendar", "server.py"
)
...
google_calendar_mcp_toolset = MCPToolset(
...
calendar_agent = LlmAgent(
    model=MODEL_CALENDAR_AGENT,
    name='calendar_agent',
    description='An agent to assist with Google Calendar related tasks.',
    instruction=CALENDAR_AGENT_SYSTEM_INSTRUCTIONS,
