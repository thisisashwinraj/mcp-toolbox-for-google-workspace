...
VALID_METADATA_FIELDS = Literal["hasThumbnail", "mimeType", "modifiedByMeTime", 
    ...
    "capabilities", "trashedTime", "webViewLink", "sharedWithMeTime",  "spaces",
    "exportLinks", "shared", "copyRequiresWriterPermission", "headRevisionId", 
    "fullFileExtension", "originalFilename", "description", "modifiedTime", 
    "viewersCanCopyContent", "viewedByMe", "modifiedByMe", "owners", "trashed", 
    "createdTime", "quotaBytesUsed", "starred", "properties", "md5Checksum", 
    "iconLink", "imageMediaMetadata", "kind", "hasAugmentedPermissions", "name", 
    "trashingUser", "driveId", "permissionIds", "contentHints", "fileExtension", 
    "permissions", "webContentLink", "*"
]
