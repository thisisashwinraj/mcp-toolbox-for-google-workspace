...
The email is securely encoded before being transmitted through the Gmail API.
...
**Expected Output:**
    {
        "result": {
            "status": "success",
            "message": "Email delivered successfully with id: sample-email-id",
            "warning": "Skipped some email addresses that were invalid.",
            "invalid_emails_in_bcc": ["invalid_email_id"]
        }
    }
"""
...
**Expected Output:**
    {
        "status": "success",
        "message": "Draft updated with id: `123abc456`.",
    }
"""
